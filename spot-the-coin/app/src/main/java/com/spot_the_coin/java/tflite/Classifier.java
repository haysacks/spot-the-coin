...
package com.spot_the_coin.java.tflite;
...
import com.spot_the_coin.java.LabelHelper;
...
public abstract class Classifier {
  ...
  private final FlexDelegate delegate = new FlexDelegate();
  private final Interpreter.Options tfliteOptions = new Interpreter.Options().addDelegate(delegate);
  ...
  public static class Recognition {
    ...
    public JSONObject getDetails(Context context) throws JSONException {
        JSONObject object = new JSONObject(LabelHelper.loadJSONFromAsset(context));
        JSONObject coinObject = (JSONObject) object.get(title);
        return coinObject;
    }

    public String getLabel() {
        int label_id = Integer.parseInt(title);
        return null;
    }
